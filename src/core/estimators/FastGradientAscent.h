...
/**
 *	\brief      FastGradientAscent object class
 *
...
class FastGradientAscent : public AbstractEstimator<ScalarType, Dimension> {
 public:
  ...
  virtual FastGradientAscent *Clone() { return new FastGradientAscent(*this); }

  /// Destructor.
  virtual ~FastGradientAscent();
  ...
  ScalarType GetInitialStepSize() const { return m_InitialStepSize; }
  /// Sets the initial step size to \e x.
  void SetInitialStepSize(const ScalarType x) { m_InitialStepSize = x; }

  /// Returns the shrink parameter for the line search.
  ScalarType GetAdaptiveShrink() const { return m_AdaptiveShrink; }
  /// Sets the shrink parameter for the line search \e x.
  void SetAdaptiveShrink(const ScalarType x) { m_AdaptiveShrink = x; }

  /// Returns the expand parameter for the line search.
  ScalarType GetAdaptiveExpand() const { return m_AdaptiveExpand; }
  /// Sets the expand parameter for the line search to \e x.
  void SetAdaptiveExpand(const ScalarType x) { m_AdaptiveExpand = x; }

  /// Returns the adaptive tolerance parameter.
  ScalarType GetAdaptiveTolerance() const { return m_AdaptiveTolerance; }
  /// Sets the adaptive tolerance parameter to \e x.
  void SetAdaptiveTolerance(const ScalarType x) { m_AdaptiveTolerance = x; }
  ...
  */
  void GradientAscentStep(const LinearVariableMapType &auxFixedEffects,
  ...
  /// Can't increase stepsize during NbIterFreeze iterations.
  unsigned int m_NbIterFreeze;
