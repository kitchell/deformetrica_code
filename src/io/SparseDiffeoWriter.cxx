...
SparseDiffeoWriter<ScalarType, Dimension>
::SparseDiffeoWriter() {
}
...
::Update()
 {
	...
	MatrixListType XT = m_Def->GetTrajectoryPositions();
	MatrixListType MomT = m_Def->GetTrajectoryMomentas();
...
template class SparseDiffeoWriter<double,2>;
template class SparseDiffeoWriter<double,3>;
