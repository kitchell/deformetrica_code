...
[TemplatePts,TemplateEdges] = VTKPolyDataReader('data/starfish2.vtk');
[TargetPts,TargetEdges] = VTKPolyDataReader('data/starfish1.vtk');
[ModelPts,ModelEdges] = VTKPolyDataReader('output/Registration_starfish2_to_subject_0__t_9.vtk');
