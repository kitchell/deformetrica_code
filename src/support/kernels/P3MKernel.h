...
class P3MKernel : public ExactKernel<ScalarType, PointDim> {
 public:
  ...
  typedef itk::Image<std::complex<ScalarType>, PointDim> ComplexImageType;
...
// void SetWorkingImage(ImageType* img) { m_WorkingImage = img; }
  ...
  /// TODO .
  void SetWorkingSpacingRatio(const ScalarType d) { m_WorkingSpacingRatio = d; }

  /// Sets the padding factor to \e d.
  void SetPaddingFactor(const ScalarType d) { m_PaddingFactor = d; }
...
// ImagePointer m_WorkingImage;
  ...
  ScalarType m_WorkingSpacingRatio;
...
// std::vector<ImagePointer> m_MeshWYYtList;
  ...
  ScalarType m_NearThresholdScale;
  ...
  static std::vector<ScalarType> m_CacheFFTHessianKernelWidths;
...
//public:
//    /// For profiling.
//    static ScalarType m_ConvolveTime;
//    static ScalarType m_ConvolveGradientTime;
//    static ScalarType m_ConvolveHessianTime;
//
//    static ScalarType m_UpdateGridTime;
//    static ScalarType m_ApplyKernelFftTime;
//    static ScalarType m_InterpolateTime;
